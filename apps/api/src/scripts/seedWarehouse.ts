...
const itemsToSeed = [
    ...
    {
        "equipo": "LÁMPARAS LED PORTÁTILES DE LUZ BLANCA DE LARGO ALCANCE DE MIN 850 LÚMENES",
        "cantidad": 8
    },
    {
    ...
    {
        "equipo": "ANALIZADOR DE ENERGÍA CLASIFICACIÓN DE CAT IV A 600V Y CAT III A 1,000V. TENDENCIA AUTOMÁTICA, FUNCIÓN DE REGISTRADOR, MEMORIA DE HASTA 600 PARÁMETROS VELOCIDAD DE MUESTREO: 200 KS/S",
        "cantidad": 1
    },
    {
        "equipo": "CÁMARA TERMOGRÁFICA TEMPERATURA MÍN.: -20°C, TEMPERATURA MÁX.: 650°C, RESOLUCIÓN IR: 160 X 120, SENSIBILIDAD TÉRMICA (NETD): 0.07°C, CAMPO DE VISIÓN (H X V): 25° X 19°, DISTANCIA FOCAL IR MÍN.: 400MM, FRECUENCIA DE CAPTURA DE IMÁGENES: 60HZ",
        "cantidad": 1
    },
    {
    ...
    {
        "equipo": "PIRÓMETRO DE RADIACIÓN TIPO INFRARROJO -40 °C A 550 ° C (DE -40 °F A 1022 °F)",
        "cantidad": 2
    },
    {
    ...
    {
        "equipo": "NIVEL ELECTRÓNICO (COMPENSADOR CON AMORTIGUACIÓN MAGNÉTICA) (PRECISIÓN: DESVIACIÓN ESTÁNDAR PARA 1 KM EN NIVELACIÓN DOBLE (ISO 17123-2) (MEDICIONES ELECTRÓNICAS: CON MIRAS DE INVAR: 0.9MM CON MIRAS ESTÁNDAR: 1.5MM - MEDICIONES ÓPTICAS: 2.0MM)",
        "cantidad": 1
    },
    {
