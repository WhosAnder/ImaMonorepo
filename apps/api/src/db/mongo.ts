...
export async function getWorkReportCollection(): Promise<
...
export async function getWarehouseReportCollection(): Promise<
  Collection<WarehouseReport>
> {
  const client = await getClient();
  const db = client.db(dbName);
...
export async function getWarehouseAdjustmentsCollection(): Promise<
  Collection<WarehouseStockAdjustment>
> {
  const client = await getClient();
  const db = client.db(dbName);
