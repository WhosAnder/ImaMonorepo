...
export function WarehouseReportPreview({
  ...
  return (
    ...
    >
      <div
        className="relative mx-auto w-full max-w-[750px] aspect-[8.5/11] p-4 text-xs leading-relaxed shadow-md overflow-hidden"
      ...
      >
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center z-0">
            <span
              className="select-none text-[90px] font-bold rotate-[-25deg] tracking-wider"
              style={{ color: "rgba(156, 163, 175, 0.1)" }}
            >
              ALMACÉN IMA
            </span>
          </div>
          ...
          <div className="relative z-10 h-full w-full flex flex-col bg-transparent">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <section className="mt-5 px-6">
                <div
                  className="rounded-t-md px-3 py-1 text-[9px] font-semibold uppercase tracking-wide"
                  style={{ backgroundColor: primaryColor, color: "#ffffff" }}
                >
                  HERRAMIENTAS QUE SE ENTREGAN
                </div>
                <div
                  className="rounded-b-md border px-3 py-2 text-[10px] space-y-1"
                  style={{
              ...
              <section className="mt-5 px-6">
                ...
                <div
                  className="min-h-[60px] rounded-b-md border px-3 py-2 text-[10px] whitespace-pre-wrap"
                  style={{
                    borderColor: primaryColor,
                    color: primaryColor,
                    backgroundColor: "#ffffff",
...
function LabeledPill({
  ...
  return (
    <div className="flex flex-col gap-1">
      <div
        className="inline-flex self-start rounded-full px-3 py-1 text-[9px] font-semibold tracking-wide"
        style={{ backgroundColor: color, color: "#ffffff" }}
      >
        {label}
      </div>
      <div
        className="min-h-[24px] rounded-full border px-3 py-1 text-[10px] font-medium"
        style={{ borderColor: color, color: color, backgroundColor: "#ffffff" }}
      >
...
function SignatureBox({
  ...
  return (
    <div>
      <div
        className="rounded-t-md px-2 py-1 text-[8px] font-semibold uppercase tracking-wide text-center"
        style={{ backgroundColor: color, color: "#ffffff" }}
      >
        {label}
      </div>
      <div
        className="rounded-b-md border px-2 py-2 text-[9px] flex flex-col justify-between min-h-[60px]"
        style={{ borderColor: color, color: color, backgroundColor: "#ffffff" }}
      >
        <div className="font-medium text-center truncate" title={name}>
          {name || "—"}
        </div>
        <div
          className="mt-1 h-[24px] border-t border-dashed flex items-end justify-center"
