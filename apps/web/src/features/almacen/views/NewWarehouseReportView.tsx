...
export const NewWarehouseReportPage: React.FC = () => {
  ...
  const onSubmit = async (data: WarehouseReportFormValues) => {
    try {
      ...
      alert(
        `Error al crear el reporte: ${error instanceof Error ? error.message : "Error desconocido"}`,
      );
    }
  };
      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-2 text-lg">
            Llena el formato de almacén para registrar la entrega de materiales.
          </p>
        </div>
                    ...
                    >
                      <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-12 md:col-span-5">
                          ...
                          <input
                            type="hidden"
                            {...register(`herramientas.${index}.sku`)}
                          />
                    ...
                    >
                      <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-12 md:col-span-5">
                          ...
                          <input
                            type="hidden"
                            {...register(`refacciones.${index}.sku`)}
                          />
